export const API_ENDPOINTS = {
  ...
  VERIFICATIONS: {
    LIST: '/v1/admin/verifications',
    STATISTICS: '/v1/admin/verifications/statistics',
    DETAILS: (id: string) => `/v1/admin/verifications/${id}`,
    DOCUMENTS: (id: string) => `/v1/admin/verifications/${id}/documents`,
    APPROVE: (id: string) => `/v1/admin/verifications/${id}/approve`,
    REJECT: (id: string) => `/v1/admin/verifications/${id}/reject`,
    REQUEST_CHANGES: (id: string) => `/v1/admin/verifications/${id}/request-changes`,
    ADD_NOTE: (id: string) => `/v1/admin/verifications/${id}/note`,
    UPDATE_STATUS: (id: string) => `/v1/admin/verifications/${id}/status`,
  },
  CATEGORIES: {
