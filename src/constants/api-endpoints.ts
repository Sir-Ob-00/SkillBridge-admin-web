export const API_ENDPOINTS = {
  ...
  VERIFICATIONS: {
    ...
    STATISTICS: '/admin/verification/statistics',
    DETAILS: (id: string) => `/admin/verification/${id}`,
    DOCUMENTS: (id: string) => `/admin/verification/${id}/documents`,
    APPROVE: (id: string) => `/admin/verification/${id}/approve`,
    REJECT: (id: string) => `/admin/verification/${id}/reject`,
    REQUEST_CHANGES: (id: string) => `/admin/verification/${id}/request-changes`,
    ADD_NOTE: (id: string) => `/admin/verification/${id}/note`,
    UPDATE_STATUS: (id: string) => `/admin/verification/${id}/status`,
  },
  CATEGORIES: {
